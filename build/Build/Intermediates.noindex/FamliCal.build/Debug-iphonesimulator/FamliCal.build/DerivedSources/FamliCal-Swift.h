...
#ifndef FAMLICAL_SWIFT_H
#define FAMLICAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FamliCal",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void)addAttendees:(NSSet * _Nonnull)values;
...
@interface FamilyEvent (SWIFT_EXTENSION(FamliCal))
@property (nonatomic, copy) NSUUID * _Nullable id;
@property (nonatomic, copy) NSUUID * _Nullable eventGroupId;
@property (nonatomic, copy) NSString * _Nullable eventIdentifier;
...
@interface FamilyMember : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@interface FamilyMember (SWIFT_EXTENSION(FamliCal))
- (void)addFamilyEventsObject:(FamilyEvent * _Nonnull)value;
- (void)removeFamilyEventsObject:(FamilyEvent * _Nonnull)value;
- (void)addFamilyEvents:(NSSet * _Nonnull)values;
- (void)removeFamilyEvents:(NSSet * _Nonnull)values;
@end

@class FamilyMemberCalendar;
@interface FamilyMember (SWIFT_EXTENSION(FamliCal))
- (void)addMemberCalendarsObject:(FamilyMemberCalendar * _Nonnull)value;
- (void)removeMemberCalendarsObject:(FamilyMemberCalendar * _Nonnull)value;
- (void)addMemberCalendars:(NSSet * _Nonnull)values;
- (void)removeMemberCalendars:(NSSet * _Nonnull)values;
@end

@class SharedCalendar;
@interface FamilyMember (SWIFT_EXTENSION(FamliCal))
- (void)addSharedCalendarsObject:(SharedCalendar * _Nonnull)value;
- (void)removeSharedCalendarsObject:(SharedCalendar * _Nonnull)value;
- (void)addSharedCalendars:(NSSet * _Nonnull)values;
- (void)removeSharedCalendars:(NSSet * _Nonnull)values;
@end
...
SWIFT_CLASS_NAMED("FamilyMemberCalendar")
@interface FamilyMemberCalendar : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@interface FamilyMemberCalendar (SWIFT_EXTENSION(FamliCal))
@property (nonatomic, copy) NSUUID * _Nullable id;
@property (nonatomic, copy) NSString * _Nullable calendarID;
@property (nonatomic, copy) NSString * _Nullable calendarName;
@property (nonatomic, copy) NSString * _Nullable calendarColorHex;
@property (nonatomic) BOOL isAutoLinked;
@property (nonatomic, strong) FamilyMember * _Nullable familyMember;
@end
...
@interface Item (SWIFT_EXTENSION(FamliCal))
@property (nonatomic, copy) NSDate * _Nullable timestamp;
@end

SWIFT_CLASS("_TtC8FamliCal23LocationSearchCompleter")
@interface LocationSearchCompleter : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface SharedCalendar : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@interface SharedCalendar (SWIFT_EXTENSION(FamliCal))
- (void)addMembersObject:(FamilyMember * _Nonnull)value;
- (void)removeMembersObject:(FamilyMember * _Nonnull)value;
